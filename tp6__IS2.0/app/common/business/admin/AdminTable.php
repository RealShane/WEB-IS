...
$(\"#search_data_export_file\").click(function(){
    var searchKey = $(\"#searchKey\").val();
    var searchValue = $(\"#searchValue\").val();
    setTimeout(location.href=\"/admin/$upper/export_file?key=\"+searchKey+\"&value=\"+searchValue, 1000);
})
    ...
    <article class=\"Hui-admin-content clearfix\">
        ...
        <div class=\"panel mt-20\">
            <div class=\"panel-body\">
                <div class=\"clearfix\">
					<span class=\"f-l\">
				        <a href=\"/admin/$upper/export_file\" class=\"btn btn-primary radius\">
...
";
    ...
    public function templateController($tableName, $allField, $origin){
        ...
        $str = rtrim($str, ',');
        foreach($allField as $key){
            $str1 .= "\$".$key['Field']." = \$value['".$key['Field']."'];";
        }
        foreach($allField as $key){
