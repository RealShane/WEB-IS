...
class OnlineJudgeSetsPaper extends Model
{

    protected $table = 'oj_sets_paper';

    public function findTargetAvailablePaper($id){
        return $this -> where('id', $id) -> where('status', '启用') -> find();
    }

    public function findAllAvailablePapers(){
