...
$(document).ready(function(){
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            url : "/admin/AdminAuthGroup/seeAll",
    ...
    $("#add").click(function(){
        layer_show('代码生成','/admin/AdminAuthGroup/viewAddEdit?id=-1',800,500);
    })
    $("#batchDelete").click(function(){
        ...
        $.ajax({
            type : "POST",
            contentType: "application/x-www-form-urlencoded",
            url : "/admin/AdminAuthGroup/batchDeleteData",
            data : {
                ids:ids
            },
            success : function(res) {
...
function edit(id) {
    layer_show('代码生成','/admin/AdminAuthGroup/viewAddEdit?id='+id,800,500);
}
...
function delete_single(id) {
    ...
    $.ajax({
        type : "POST",
        contentType: "application/x-www-form-urlencoded",
        url : "/admin/AdminAuthGroup/deleteData",
        data : {
            target:id
        },
        success : function(res) {
