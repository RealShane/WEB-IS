...
$(document).ready(function(){
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            url : "/admin/Secondclassclasses/seeAll",
                ...
                for(let key of res.result){
                    ...
                    $("#dataRoom").append(
                        "<tr>" +
                            ...
                            "<td>"+key['id']+"</td>" +"<td>"+key['classes_id']+"</td>" +"<td>"+key['classes_name']+"</td>" +"<td>"+key['grade']+"</td>" +"<td>"+key['year']+"</td>" +
                            "<td class='td-manage'>" +
    ...
    $("#add").click(function(){
        layer_show('代码生成','/admin/Secondclassclasses/viewAddEdit?id=-1',800,500);
    })
    $("#batchDelete").click(function(){
        ...
        $.ajax({
            type : "POST",
            contentType: "application/x-www-form-urlencoded",
            url : "/admin/Secondclassclasses/batchDeleteData",
            data : {
                ids:ids
            },
            success : function(res) {
...
function edit(id) {
    layer_show('代码生成','/admin/Secondclassclasses/viewAddEdit?id='+id,800,500);
}
...
function delete_single(id) {
    ...
    $.ajax({
        type : "POST",
        contentType: "application/x-www-form-urlencoded",
        url : "/admin/Secondclassclasses/deleteData",
        data : {
            target:id
        },
        success : function(res) {
