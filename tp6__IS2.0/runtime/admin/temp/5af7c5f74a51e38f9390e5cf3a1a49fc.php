<?php /*a:3:{s:62:"/library/WebServer/Documents/tp6/app/admin/view/user/user.html";i:1579951987;s:65:"/library/WebServer/Documents/tp6/app/admin/view/public/_meta.html";i:1579946887;s:67:"/library/WebServer/Documents/tp6/app/admin/view/public/_footer.html";i:1579951299;}*/ ?>
    ...
    <article class="Hui-admin-content clearfix">
                    ...
                    <span class="col-xs-8 form-item-control">
                        <span class="select-box">
                            <select id="searchKey" class="select">
                                <option value='id'>自增id</option><option value='username'>用户名</option><option value='password'>密码</option><option value='password_salt'>密码盐</option><option value='last_login_ip'>上次登陆IP</option><option value='last_login_time'>上次登陆时间</option><option value='create_time'>创建时间</option><option value='update_time'>更新时间</option>
                            </select>
                        </span>
                    </span>
                </div>
        ...
        <div class="panel mt-20">
            <div class="panel-body">
                <div class="clearfix">
					<span class="f-l">
				        <a href="/admin/AdminUser/export_file" class="btn btn-primary radius">
                ...
                <div class="mt-20 clearfix">
                    <table id='dataSingleSet' class="table table-border table-bordered table-bg table-hover table-sort">
                        <thead>
                        <tr>
                            <th scope="col" colspan="10">管理员用户表</th>
                        </tr>
                        <tr class="text-c">
                            <th></th>
                            <th id='id'>自增id</th><th id='username'>用户名</th><th id='password'>密码</th><th id='password_salt'>密码盐</th><th id='last_login_ip'>上次登陆IP</th><th id='last_login_time'>上次登陆时间</th><th id='create_time'>创建时间</th><th id='update_time'>更新时间</th>
                            <th>操作</th>
                        </tr>
                        </thead>
                        <tbody id='dataRoom'>
...
<script src="/assets/js/admin/admin_user/admin.user.js"></script>
