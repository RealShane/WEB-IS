<?php /*a:3:{s:71:"/library/WebServer/Documents/tp6/app/admin/view/generate/test/test.html";i:1579962659;s:65:"/library/WebServer/Documents/tp6/app/admin/view/public/_meta.html";i:1579946887;s:67:"/library/WebServer/Documents/tp6/app/admin/view/public/_footer.html";i:1579951299;}*/ ?>
    ...
    <article class="Hui-admin-content clearfix">
                    ...
                    <span class="col-xs-8 form-item-control">
                        <span class="select-box">
                            <select id="searchKey" class="select">
                                <option value='id'>自增id</option><option value='aaa'>aaa</option><option value='bbb'>bbb</option>
                            </select>
                        </span>
                    </span>
                </div>
        ...
        <div class="panel mt-20">
            <div class="panel-body">
                <div class="clearfix">
					<span class="f-l">
				        <a href="/admin/Test/export_file" class="btn btn-primary radius">
                ...
                <div class="mt-20 clearfix">
                    <table id='dataSingleSet' class="table table-border table-bordered table-bg table-hover table-sort">
                        <thead>
                            <tr>
                                <th scope="col" colspan="5">测试</th>
                            </tr>
                            <tr class="text-c">
                                <th></th>
                                <th id='id'>自增id</th><th id='aaa'>aaa</th><th id='bbb'>bbb</th>
                                <th>操作</th>
                            </tr>
                        </thead>
                        <tbody id='dataRoom'>
...
<script src="/assets/js/admin/generate/test/test.js"></script>
