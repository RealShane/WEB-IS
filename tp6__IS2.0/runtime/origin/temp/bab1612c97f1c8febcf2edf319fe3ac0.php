<?php /*a:4:{s:70:"/library/WebServer/Documents/tp6/app/origin/view/synthesize/score.html";i:1580637842;s:66:"/library/WebServer/Documents/tp6/app/origin/view/public/_meta.html";i:1579954223;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_header.html";i:1580640775;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_footer.html";i:1580641285;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<!-- /电脑版本导航栏 -->
<header class="page-header" data-background="/static/is/images/banner/synthesize.jpg" data-stellar-background-ratio="1.15">
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-8">
				...
				<form id="contact" name="contact" method="post">
					<div class="form-group" id="input_remove">
						<input type="text" id="mark" autocomplete="off" required>
						<span>请打分</span>
					</div>
					<button id="commit" type="button" class="btn btn-lg btn-success lt b-white b-2x btn-block btn-rounded">
						<i class="icon-arrow-right pull-right"></i>
						<span class="m-r-n-lg" id="button_remove">打分</span>
					</button>
					<br>
...
<script src="/assets/js/origin/synthesize/score.js"></script>
</body>
</html>