<?php /*a:4:{s:78:"/library/WebServer/Documents/tp6/app/origin/view/time_postal/write_letter.html";i:1580637958;s:66:"/library/WebServer/Documents/tp6/app/origin/view/public/_meta.html";i:1580972412;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_header.html";i:1580866621;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_footer.html";i:1580972412;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<!-- /电脑版本导航栏 -->
<header class="page-header" data-background="/static/is/images/banner/time_postal.jpg" data-stellar-background-ratio="1.15">
	<div class="container">
		<h1>写信</h1>
		<p>Write letter</p>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a>写信</a></li>
			<li class="breadcrumb-item active" aria-current="page">WL</li>
		</ol>
	</div>
</header>
<section class="blog">
				...
				<section class="contact">
					<div class="contact-form">
						<form id="contact" name="contact" method="post">
							...
							<div class="form-group">
								<textarea id="letter" autocomplete="off" required></textarea>
								<span>信件内容</span>
							</div>
							<div class="form-group">
								<select id="status" class="form-control rounded input-lg text-center no-border">
									<option value="">选择信件类型</option>
									<option>公开信</option>
									<option>时光信件</option>
								</select>
							</div>
...
<script src="/assets/js/origin/time_postal/write.letter.js"></script>
</body>
</html>