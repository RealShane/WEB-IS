<?php /*a:4:{s:72:"/library/WebServer/Documents/tp6/app/origin/view/online_judge/paper.html";i:1581073796;s:66:"/library/WebServer/Documents/tp6/app/origin/view/public/_meta.html";i:1580972412;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_header.html";i:1580866621;s:68:"/library/WebServer/Documents/tp6/app/origin/view/public/_footer.html";i:1580972412;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<!-- /电脑版本导航栏 -->
<header class="page-header" data-background="/static/is/images/banner/online_judge.jpg" data-stellar-background-ratio="1.15">
    <div class="container">
        <h1>通信答题</h1>
        <p>Online Judge</p>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a>答题</a></li>
            <li class="breadcrumb-item active" aria-current="page">OJ</li>
        </ol>
    </div>
</header>
<section class="blog">
            ...
            <div class="col-lg-8">
                ...
                <div class="post">
                    ...
                    <div class="post-content">
                        ...
                        <p class="post-intro" id="body_set">
                        </p>
                    </div>
                    <small>建议：先保存检查完后再判题，一旦判题不可修改！</small>
                    <small>注意：如之前保存过，修改之后直接点击判题，答案将遵从原保存答案而不是本次修改后的答案！</small>
                    <form id="questions_set" class="layui-form layui-form-pane">
                    ...
                    <button id="type_commit" type="button" class="btn btn-lg btn-success lt b-white b-2x btn-block btn-rounded">
                        <i class="icon-arrow-right pull-right"></i>
                        <span class="m-r-n-lg">保存</span>
                    </button>
                    <button id="type_judge" type="button" class="btn btn-lg btn-danger lt b-white b-2x btn-block btn-rounded">
                        <i class="icon-arrow-right pull-right"></i>
                        <span class="m-r-n-lg">判题</span>
                    </button>
                    <div id="warn">
                        <div id="remove_warn">
            ...
            <div class="col-lg-4">
                <aside class="sidebar">
                    <div class="widget">
                        ...
                        <ul class="categories">
                            <li><a href="/origin/Index/onlineJudgeCatalogue">试卷列表</a></li>
                            <li><a href="/origin/Index/onlineJudgePersonalPaper">做过的试卷</a></li>
                        </ul>
                    </div>

                    <div class="widget">
                        <h4 class="title">简介</h4>
                        <p>这里是通信答题：仅对17/18通信工程开放</p>
                    </div>
...
<script src="/assets/js/origin/online_judge/paper.js"></script>
</body>
</html>