<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/originfetch/indexbw.html";i:1566993121;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:84:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_login.html";i:1566468789;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	$().ready(function(){
		...
		$("#press").click(function(){
			...
			var message=$("#message").val();
  			$.ajax({
				url:"<?php echo url('origin/origin/signbw'); ?>",
	  			async:true,
				type:'post',
				dataType:'json',
				data:{
	...
	$().ready(function(){
    	$().ready(function(){
    		...
    		$.ajax({
        		type:'post',
				async:true,
				url:"<?php echo url('origin/origin/showbw'); ?>",
        		data:{
					name:name,
					myid:myid,
					classes:classes
					...
					for(var i=1;i<=res.len;i++){
						if(res.data[i][0]["zc"+myid]!=null){
							...
							if(res.data[i][0]["type"]=="上一届"){
								...
								var img=$("<img src='/IS/public/static/images/services-icon08.png' alt='Image'>");
            					img.appendTo(figure);
								var name=$("<figcaption><h5><a href='/IS/public/score_BW?id="+res.data[i][0].myid+"'>"+res.data[i][0].name+"</a></h5></figcaption>");
            					name.appendTo(figure);
							}else{
								var div=$("<div class='col-lg-4 col-md-6'></div>");
            					div.appendTo("#new");
