<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/secondfetch/index.html";i:1564362628;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:86:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_nologin.html";i:1566468798;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
    		...
    		<div class="row" id="frame">
				<script type="text/javascript">
					...
					$(document).ready(function(){
  						$.ajax({
							url:"<?php echo url('origin/secondclass/course'); ?>",
	  						async:false,
							dataType:'json',
							success(res){
            					var data=res;
            					...
            					for(var i=0;i<rowCount;i++){
									var limitid=res[i].limitid;
									var limitsize=res[i].limitsize;
									if(limitid>=limitsize){
										var item=$("<div class='col-lg-4 col-md-6 wow fadeInUp' data-wow-delay='0s'><figure data-stellar-ratio='1.07'></figure></div>");
            							item.appendTo("#frame");
										var link=$("<a></a>");
            							link.appendTo(item);
										var img=$("<img src='/IS/public"+data[i].imgimage+"' alt='Image'>");
            							img.appendTo(link);
										var content=$("<figcaption></figcaption>");
            							content.appendTo(item);
                						var name=$("<h5>注意：此课程已被选完</br>"+data[i].name+"</h5>");
										name.appendTo(content);
										var myname=$("<small>讲师："+data[i].myname+"</small><br/>");
										myname.appendTo(content);
										var location=$("<small>地点："+data[i].location+"</small><br/>");
										location.appendTo(content);
										var time=$("<small>时间："+data[i].time+"</small>");
										...
										var content=$("<figcaption></figcaption>");
            							content.appendTo(item);
                						var name=$("<h5><a href='"+data[i].link+"'>"+data[i].name+"</a></h5>");
										name.appendTo(content);
										var myname=$("<small>讲师："+data[i].myname+"</small><br/>");
										myname.appendTo(content);
										var location=$("<small>地点："+data[i].location+"</small><br/>");
