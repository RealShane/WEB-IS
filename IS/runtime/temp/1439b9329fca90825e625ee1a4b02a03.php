<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/index/register.html";i:1566633246;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:84:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_login.html";i:1566468789;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$().ready(function(){
  		$("#press").click(function(){
			...
			var myid=$("#id").val();
  			$.ajax({
				url:"<?php echo url('origin/forum/registerfunc'); ?>",
	  			async:true,
				type:'post',
				dataType:'json',
				data:{
				...
				success(res){
					alert(res.message);
					if(res.is_success==0){
						setTimeout("location.href='/IS/public/'");//注册成功跳转
					}
				}
			});
  		});
        		...
        		<div class="col-lg-6">
        			<div class="contact-form">	
			 			<form id="contact" name="contact" method="post">
							...
							<div class="form-group"> 
            					<input type="text" name="classes" id="classes" autocomplete="off" required>
            					<span>班级（年级+班级，例：18计科二班/18通信工程）</span>
          					</div>
							<div class="form-group">
