<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/forumfetch/arctic_info.html";i:1566202596;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:84:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_login.html";i:1566468789;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$().ready(function(){
		...
		$.ajax({
			url:"<?php echo url('origin/forum/info'); ?>",
	  		async:true,
			type:'post',
			dataType:'json',
			data:{
		...
		$.ajax({
			url:"<?php echo url('origin/forum/comment_show'); ?>",
	  		async:true,
			type:'post',
			dataType:'json',
			data:{
		...
		$("#press").click(function(){
			...
			if(seed.status!=0){
				...
				$.ajax({
					url:"<?php echo url('origin/forum/comment'); ?>",
	  				async:true,
					type:'post',
					dataType:'json',
					data:{
