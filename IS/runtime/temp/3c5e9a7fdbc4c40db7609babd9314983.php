<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:103:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/pofficefetch/futureletter.html";i:1566198596;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:84:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_login.html";i:1566468789;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$().ready(function(){
		...
		if(seed.status!=0){
			//没有登录跳转
			document.cookie="email_type=futureletter";
		...
		$().ready(function(){
			$("#press").click(function(){
    			...
    			$.ajax({
        			type:'post',
					async:true,
					url:"<?php echo url('origin/poffice/future_letter'); ?>",
        			data:{
						name:name,
						myid:myid,
						classes:classes,
					...
					success:function(res){ 
          				if(res==0){
							alert("写信成功");
							setTimeout("location.href='/IS/public/FutureLetterList'");//跳转
						}else{
							alert("写信失败");
						}
					},
...
<script type="text/javascript">
	...
	<header class="page-header" data-background="/IS/public/static/images/time.jpg" data-stellar-background-ratio="1.15">
		<div class="container">
			<h1>时光信件</h1>
			<p>Write future letter</p>
		  	<ol class="breadcrumb">
    			<li class="breadcrumb-item"><a>写信</a></li>
				<li class="breadcrumb-item active" aria-current="page">WFL</li>
  			</ol>
		</div>
	</header>
