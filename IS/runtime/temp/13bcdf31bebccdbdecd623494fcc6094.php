<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"/www/wwwroot/serv.huihuagongxue.top/IS/public/../application/origin/view/originfetch/scorezc.html";i:1566292366;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/head.html";i:1564733160;s:84:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/nav_login.html";i:1566468789;s:79:"/www/wwwroot/serv.huihuagongxue.top/IS/application/origin/view/public/foot.html";i:1566445837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	$(function(){
    	...
    	$().ready(function(){
    		$.ajax({
        		type:'get',
				async:true,
        		url:"<?php echo url('origin/origin/showsingle'); ?>",
        		data:{
					name:name,
					myid:myid,
					classes:classes,
    	...
    	$().ready(function(){
			$("#press").click(function(){
    			...
    			$.ajax({
        			type:'get',
					async:true,
					url:"<?php echo url('origin/origin/score'); ?>",
					data:{
						myid:myid,
						classes:classes,
						target:target,
